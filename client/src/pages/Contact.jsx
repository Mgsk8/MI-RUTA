                ...
                <div class="grid lg:grid-cols-3 items-center">
                    <div class="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
                        <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <h4 class="text-gray-800 text-base font-bold mt-4">Visita nuestra oficina</h4>
                            <p class="text-sm text-gray-600 mt-2">Univalle Buga</p>
                        </div>
                        <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <p class="text-sm text-gray-600 mt-2">+314766666</p>
                        </div>
                        <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                            ...
                            <h4 class="text-gray-800 text-base font-bold mt-4">Correo</h4>
                            <p class="text-sm text-gray-600 mt-2">info@miruta.com</p>
                        </div>
                        <div class="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
                    ...
                    <div class="lg:col-span-2 bg-[#0a4275] rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
                        <h2 class="text-3xl text-white text-center font-bold mb-6">Contactanos</h2>
                        <form>
                            <div class="max-w-md mx-auto space-y-3">
                                <input type='text' placeholder='Nombre'
                                    class="w-full  rounded-lg py-3 px-6 text-sm outline-none" />
                                <input type='email' placeholder='Email'
                                    class="w-full  rounded-lg py-3 px-6 text-sm outline-none" />
                                <input type='email' placeholder='Numero Telefonico'
                                    class="w-full  rounded-lg py-3 px-6 text-sm outline-none" required/>
                                <textarea placeholder='Mensaje' rows="6"
                                    class="w-full  rounded-lg px-6 text-sm pt-3 outline-none"></textarea>
                                <button type='button'
