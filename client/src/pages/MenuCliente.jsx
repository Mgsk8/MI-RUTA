...
export default function MenuCliente() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-700 via-gray-600 to-gray-500">
      <div className="max-w-5xl w-full text-white py-10 px-6 rounded-lg shadow-2xl bg-gray-800 bg-opacity-80">
        <div className="text-center mt-10 mb-6">
          ...
          <p className="text-gray-300 text-base mt-4 italic tracking-wide leading-relaxed">
            Explora los{" "}
            <span className="text-orange-400 font-bold">mejores lugares</span> a
            tu disposición
          </p>
        </div>
      </div>
